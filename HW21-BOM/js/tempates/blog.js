      ...
      return `<section class="blog" id="blog">
                <div class="container">
                    ...
                    <div class="search-wrap">
                      <div class="search">
                          <input class="search__input sortByAuthor" type="search" placeholder="${data.searchAuthor.placeholder}">
                          <input class="search__submit" type="submit">
                      </div>
                        <div class="search">
                          <input class="search__input sortByTitle" type="search" placeholder="${data.searchTitle.placeholder}">
                          <input class="search__submit" type="submit">
                      </div>
                    </div>
          ...
          return `<div class="blog-post blog-post--video">
                    ...
                    <div class="blog-post__detail">
                        ...
                        <div class="blog-post__body">
                            ...
                            <a href="${data.body.link.url}" class="btn" data-id=${data.id}>${data.body.link.text}</a>
                        </div>
                    </div>
                </div>`;
        case 'music':
